      ...
      <View style={styles.css.userInformation}>
        <View style={styles.css.userInformationHeader}>
          ...
          <View style={styles.css.userInformationQtys}>
            ...
            <TouchableOpacity
              style={styles.css.userInformationQtysComponent}
              onPress={() => navigation.push("FollowTab",{routeTab:'Followers',userId})}
            >
              <Text style={[styles.css.boldFont, styles.css.informationQty]}>
                {userFollowerQty}
              </Text>
            ...
            <TouchableOpacity
              style={styles.css.userInformationQtysComponent}
              onPress={() => navigation.push("FollowTab",{routeTab:'Followings',userId})}
            >
              <Text style={[styles.css.boldFont, styles.css.informationQty]}>
                {userFollowingQty}
              </Text>
